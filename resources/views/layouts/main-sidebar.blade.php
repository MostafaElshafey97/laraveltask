    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <li class="side-item side-item-category">items</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <span class="side-menu__label">items</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'shops')) }}">shops</a></li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'customers')) }}">customers</a></li>
                    </ul>
                </li>
        </ul>
    </div>
